              ...
              <>
                 ...
                 <ExcelTable 
                   columns={[
                    ...
                    { key: 'bestelldatumFormatiert', label: '0️⃣ Bestellung', width: '110px', align: 'center', sumable: false },
                    { key: 'produktionsstart', label: '1️⃣ Prod. Fertig', width: '110px', align: 'center', sumable: false, format: (v: string) => v || '-' },
                    { key: 'lkwAbfahrtChina', label: '2️⃣ LKW ab CN', width: '110px', align: 'center', sumable: false, format: (v: string) => v || '-' },
                    { key: 'ankunftHafenChina', label: '3️⃣ Hafen CN', width: '110px', align: 'center', sumable: false, format: (v: string) => v || '-' },
                    { key: 'schiffAbfahrt', label: '4️⃣ Schiff ab', width: '120px', align: 'center', sumable: false, format: (v: string) => v || '-' },
                    { key: 'ankunftHafenDE', label: '5️⃣ Hafen DE', width: '110px', align: 'center', sumable: false, format: (v: string) => v || '-' },
                    { key: 'erwarteteAnkunftFormatiert', label: '6️⃣ Ank. Werk', width: '110px', align: 'center', sumable: false },
                    { key: 'verfuegbarAb', label: '7️⃣ Verfügbar', width: '110px', align: 'center', sumable: false, format: (v: string) => v || '-' },
                    { key: 'bestellmenge', label: 'Bestellmenge', width: '110px', align: 'right', sumable: true, format: (v: number) => v > 0 ? formatNumber(v, 0) + ' Stk' : '-' }
                   ]}
            ...
            <div className="mt-8 bg-blue-50 rounded-lg p-4 border border-blue-100">
              ...
              <ExcelTable
                columns={[
                  ...
                  { key: 'hafenBacklog', label: 'Am Hafen', width: '110px', align: 'right', sumable: false }
                ]}
                data={(() => {
